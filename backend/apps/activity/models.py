...
from django.contrib.auth.models import AbstractUser, BaseUserManager, PermissionsMixin, User, Task, Project
...
class Notification(models.Model):
    ...
    entity_type = models.CharField(_("entity type"), max_length=16, choices=EntityType.choices)
